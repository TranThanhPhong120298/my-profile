(() => {
    ...
    function wrappedRegisterElement(tagName, options) {
      ...
      function wrapCustomElementCallback(name, fullName) {
        ...
        proto[fullName] = function () {
          ...
          return makeMeasurement(name, tagName, counter, () =>
      ...
      proto.createdCallback = function () {
        ...
        return makeMeasurement("created", tagName, counter, () =>
      ...
      return makeMeasurement("registered", tagName, null, () =>
  ...
  if (window.customElements) {
    ...
    function wrappedDefineElement(tagName, constructor) {
      ...
      return makeMeasurement("registered", tagName, null, () =>
        boundDefine(tagName, constructor)
      );
    }
  ...
  window._summarizeRange = function (start, end, threshold = 0.5) {
    ...
    for (let operation of operations) {
      const duration = inRange.reduce(
        (v, m) => v + (m.operation === operation ? m.duration : 0),
        0
      );
      if (duration > 1) {
